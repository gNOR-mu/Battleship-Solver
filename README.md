...
- Se utiliza un algoritmo FastPRNG personalizado con Xorshift64 en vez de ThreadLocalRandom para valores aleatorios.
...
- Reglas de diseño en [Diseño.md](doc/Diseño.md)
